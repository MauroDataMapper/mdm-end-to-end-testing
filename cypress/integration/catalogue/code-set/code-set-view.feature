...
Feature: Viewing Code Sets

    As a user of Mauro
    I want to select a Code Set and view its information
    ...
    Scenario Outline: Viewing the standard Code Set details
    ...
    Scenario Outline: Viewing a draft Code Set
        When I click on "<label>" with version "<version>" in the model tree
        Then The catalogue item with the name "<label>" is displayed
    ...
    Scenario Outline: Viewing a finalised Code Set
        When I click on "<label>" with version "<version>" in the model tree
        Then The catalogue item with the name "<label>" is displayed
