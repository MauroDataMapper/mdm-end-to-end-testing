...
Feature: Viewing Reference Data Models

    As a user of Mauro
    I want to select a Reference Data Model and view its information
    ...
    Scenario Outline: Viewing the standard Reference Data Model details
    ...
    Scenario Outline: Viewing a draft Reference Data Model
        When I click on "<label>" with version "<version>" in the model tree
        Then The catalogue item with the name "<label>" is displayed
    ...
    @exclude
    Scenario Outline: Viewing a finalised Reference Data Model
        When I click on "<label>" with version "<version>" in the model tree
        Then The catalogue item with the name "<label>" is displayed
